...
# Set load paths
# =============================================================================
ANNOTATION_NOTES = ("sourcedata/BIDS_Neumann_ECOG_LFP/meta_infos/"
                    "Data_Notes_Berlin.xlsx", "TO_JSON")
GOOD_FILES_JSON = ("sourcedata/BIDS_Neumann_ECOG_LFP/meta_infos/"
                   "Berlin_MedOffOn.json")
...
ANNOTATIONS = join("derivatives", "annotations")
